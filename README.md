...
<div align="center">
  <a href="https://github.com/Salvaberticci/sistema-gestion-productos/releases/download/v1.2/El_Rebusque_Maestro_v1.2.zip">
    <img src="https://img.shields.io/badge/⬇️_Descargar_Versión_Maestra_(v1.2)-0B0E14?style=for-the-badge&logo=windows&logoColor=58A6FF&color=58A6FF&labelColor=161B22" alt="Descargar Maestro" />
  </a>
</div>

## 🛠️ Guía Rápida de Uso (Versión Maestra v1.2)
1. Descarga el archivo `.zip` usando el botón de arriba.
2. Descomprime la carpeta `El_Rebusque_Maestro_v1.2` en tu computadora o pendrive.
3. Abre la carpeta y ejecuta `Sistema_El_Rebusque.exe` (con ícono oficial).
4. **IMPORTANTE**: No muevas el `.exe` fuera de su carpeta, ya que necesita tener cerca la base de datos, el archivo Excel y la carpeta de imágenes para funcionar al 100%.
